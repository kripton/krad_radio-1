...
int kr_mixer_crate_to_string (kr_crate *kr_crate, char **string);
...
void kr_mixer_remove_portgroup (kr_client *client, char *portgroupname);
...
void kr_mixer_set_effect_control (kr_client *client, char *portgroup_name, int effect_num,
                                  ...
                                  kr_easing easing);
int kr_mixer_get_info_wait(kr_client *client, uint32_t *sample_rate,
