...
int info_unpack_fr_ebml(kr_ebml *ebml, uber_St *uber) {
  ...
  kr_volume_info_fr_ebml,kr_analog_info_fr_ebml,
  ...
  krad_link_av_mode_t_fr_ebml,kr_txpdr_su_type_t_fr_ebml,
  krad_link_transport_mode_t_fr_ebml,kr_transponder_path_io_type_fr_ebml,
  kr_transponder_info_fr_ebml,kr_transponder_path_io_path_info_fr_ebml,
