...
int info_unpack_fr_ebml(kr_ebml *ebml, uber_St *uber) {
  const info_unpack_fr_ebml_func fr_ebml_functions[69] = {kr_alsa_info_fr_ebml,
  ...
  kr_compositor_path_info_fr_ebml,kr_compositor_info_fr_ebml,
  kr_compositor_path_patch_fr_ebml,kr_pos_fr_ebml,
  ...
  kr_mixer_path_info_fr_ebml,kr_mixer_path_patch_fr_ebml,
  ...
  kr_transponder_path_info_fr_ebml,kr_transponder_path_patch_fr_ebml,
