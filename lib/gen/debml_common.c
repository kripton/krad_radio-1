...
int info_unpack_fr_ebml(kr_ebml *ebml, uber_St *uber) {
  const info_unpack_fr_ebml_func fr_ebml_functions[68] = {kr_alsa_info_fr_ebml,
  ...
  kr_mixer_adv_ctl_fr_ebml,kr_mixer_path_info_fr_ebml,
  kr_mixer_path_patch_fr_ebml,kr_nil_fr_ebml,
  kr_radio_payload_type_fr_ebml,kr_radio_payload_fr_ebml,
  ...
  kr_transponder_path_patch_fr_ebml,kr_v4l2_state_fr_ebml,
