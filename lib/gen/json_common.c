...
int info_pack_to_json(char *json, uber_St *uber, int32_t max) {
  const info_pack_to_json_func to_json_functions[65] = {kr_alsa_info_to_json,
  ...
  kr_compositor_source_info_to_json,kr_compositor_path_type_info_to_json,
  kr_compositor_path_info_to_json,kr_sprite_info_to_json,
  kr_text_info_to_json,kr_pos_to_json,
  ...
  kr_volume_info_to_json,kr_analog_info_to_json,
