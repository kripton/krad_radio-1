...
int info_pack_to_json(char *json, uber_St *uber, int32_t max) {
  const info_pack_to_json_func to_json_functions[54] = {kr_alsa_info_to_json,
  ...
  kr_compositor_info_to_json,kr_compositor_path_patch_to_json,
  kr_pos_to_json,kr_perspective_view_to_json,
  kr_perspective_to_json,krad_codec_t_to_json,
  ...
  kr_mixer_path_patch_to_json,kr_sfx_control_to_json,
