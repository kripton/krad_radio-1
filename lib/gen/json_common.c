...
int info_pack_to_json(char *json, uber_St *uber, int32_t max) {
  const info_pack_to_json_func to_json_functions[68] = {kr_alsa_info_to_json,
  ...
  kr_mixer_adv_ctl_to_json,kr_mixer_path_info_to_json,
  kr_mixer_path_patch_to_json,kr_nil_to_json,
  kr_radio_payload_type_to_json,kr_radio_payload_to_json,
