...
int info_pack_to_ebml(kr_ebml *ebml, uber_St *uber) {
  const info_pack_to_ebml_func to_ebml_functions[69] = {kr_alsa_info_to_ebml,
  ...
  kr_compositor_path_info_to_ebml,kr_compositor_path_patch_to_ebml,
  kr_pos_to_ebml,kr_perspective_view_to_ebml,
  kr_perspective_to_ebml,krad_codec_t_to_ebml,
  ...
  kr_mixer_path_info_to_ebml,kr_mixer_path_patch_to_ebml,
  ...
  kr_transponder_path_info_to_ebml,kr_transponder_path_patch_to_ebml,
