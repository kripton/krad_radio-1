...
int info_pack_to_ebml(kr_ebml *ebml, uber_St *uber) {
  const info_pack_to_ebml_func to_ebml_functions[71] = {kr_alsa_info_to_ebml,
  ...
  kr_compositor_path_info_to_ebml,kr_compositor_info_to_ebml,
  kr_compositor_path_patch_to_ebml,kr_pos_to_ebml,
