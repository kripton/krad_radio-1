...
int info_pack_to_ebml(kr_ebml *ebml, uber_St *uber) {
  ...
  kr_crate2_to_ebml,kr_easing_to_ebml,
  ...
  kr_mixer_path_type_to_ebml,kr_mixer_path_info_to_ebml,
  kr_nil_to_ebml,kr_radio_payload_type_to_ebml,
  ...
  kr_volume_info_to_ebml,kr_analog_info_to_ebml,
  ...
  krad_link_av_mode_t_to_ebml,kr_txpdr_su_type_t_to_ebml,
  krad_link_transport_mode_t_to_ebml,kr_transponder_path_io_type_to_ebml,
  kr_transponder_info_to_ebml,kr_transponder_path_io_path_info_to_ebml,
  kr_transponder_path_io_info_to_ebml,kr_transponder_path_info_to_ebml,
