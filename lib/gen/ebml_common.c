...
int info_pack_to_ebml(kr_ebml *ebml, uber_St *uber) {
  const info_pack_to_ebml_func to_ebml_functions[70] = {kr_alsa_info_to_ebml,
  ...
  kr_mixer_adv_ctl_to_ebml,kr_mixer_path_info_to_ebml,
  kr_mixer_path_patch_to_ebml,kr_nil_to_ebml,
  kr_radio_payload_type_to_ebml,kr_radio_payload_to_ebml,
