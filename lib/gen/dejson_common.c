...
int info_unpack_fr_json(char *json, uber_St *uber) {
  ...
  kr_compositor_path_info_fr_json,kr_compositor_info_fr_json,
  kr_compositor_path_patch_fr_json,kr_pos_fr_json,
  ...
  kr_mixer_adv_ctl_fr_json,kr_mixer_path_info_fr_json,
  kr_mixer_path_patch_fr_json,kr_nil_fr_json,
  kr_radio_payload_type_fr_json,kr_radio_payload_fr_json,
