...
int info_unpack_fr_json(char *json, uber_St *uber) {
  const info_unpack_fr_json_func fr_json_functions[65] = {kr_alsa_info_fr_json,
  ...
  kr_compositor_source_info_fr_json,kr_compositor_path_type_info_fr_json,
  kr_compositor_path_info_fr_json,kr_sprite_info_fr_json,
  kr_text_info_fr_json,kr_pos_fr_json,
