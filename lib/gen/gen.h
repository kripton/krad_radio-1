...
typedef enum {
  ...
  TEXT_KR_TRANSPONDER_PATH_PATCH,
  TEXT_KR_V4L2_STATE,
  TEXT_KR_V4L2_MODE,
  TEXT_KR_V4L2_INFO,
...
typedef enum {
  ...
  JSON_KR_TRANSPONDER_PATH_PATCH,
  JSON_KR_V4L2_STATE,
  JSON_KR_V4L2_MODE,
  JSON_KR_V4L2_INFO,
...
typedef enum {
  ...
  DEJSON_KR_COMPOSITOR_CONTROL,
  DEJSON_KR_COMPOSITOR_CONTROLS,
  DEJSON_KR_SPRITE_INFO,
  DEJSON_KR_TEXT_INFO,
  DEJSON_KR_VECTOR_INFO,
  DEJSON_KR_COMPOSITOR_PATH_INFO,
  DEJSON_KR_COMPOSITOR_INFO,
  DEJSON_KR_COMPOSITOR_PATH_PATCH,
  DEJSON_KR_POS,
  DEJSON_KR_PERSPECTIVE_VIEW,
  DEJSON_KR_PERSPECTIVE,
  DEJSON_KRAD_CODEC_T,
  ...
  DEJSON_KR_ADAPTER_PATH_DIRECTION,
  DEJSON_KR_ADAPTER_API,
  DEJSON_KR_ADAPTER_API_INFO,
  DEJSON_KR_ADAPTER_API_PATH_INFO,
  DEJSON_KR_ADAPTER_INFO,
  DEJSON_KR_ADAPTER_PATH_INFO,
  DEJSON_KRAD_LINK_AV_MODE_T,
  DEJSON_KR_TXPDR_SU_TYPE_T,
  DEJSON_KRAD_LINK_TRANSPORT_MODE_T,
  DEJSON_KR_TRANSPONDER_PATH_IO_TYPE,
  DEJSON_KR_TRANSPONDER_INFO,
  DEJSON_KR_TRANSPONDER_PATH_IO_PATH_INFO,
  DEJSON_KR_TRANSPONDER_PATH_IO_INFO,
  DEJSON_KR_TRANSPONDER_PATH_INFO,
  DEJSON_KR_TRANSPONDER_PATH_PATCH,
...
typedef enum {
  ...
  EBML_KR_TRANSPONDER_PATH_PATCH,
  EBML_KR_V4L2_STATE,
  EBML_KR_V4L2_MODE,
  EBML_KR_V4L2_INFO,
...
typedef enum {
  ...
  DEBML_KR_COMPOSITOR_PATH_PATCH,
  DEBML_KR_POS,
  ...
  DEBML_KR_TRANSPONDER_PATH_PATCH,
  DEBML_KR_V4L2_STATE,
  DEBML_KR_V4L2_MODE,
  DEBML_KR_V4L2_INFO,
...
typedef enum {
  ...
  HELPERS_KR_COMPOSITOR_PATH_PATCH,
  HELPERS_KR_POS,
  ...
  HELPERS_KR_TRANSPONDER_PATH_PATCH,
