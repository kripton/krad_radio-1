...
typedef enum {
  ...
  TEXT_KR_VOLUME_INFO,
  TEXT_KR_ANALOG_INFO,
  TEXT_KR_TRANSPONDER_PATH_TYPE,
  TEXT_KR_TRANSPONDER_PATH_TYPE_INFO,
...
typedef enum {
  ...
  JSON_KR_VOLUME_INFO,
  JSON_KR_ANALOG_INFO,
  JSON_KR_TRANSPONDER_PATH_TYPE,
  JSON_KR_TRANSPONDER_PATH_TYPE_INFO,
...
typedef enum {
  ...
  DEJSON_KR_TRANSPONDER_PATH_TYPE,
  DEJSON_KR_TRANSPONDER_PATH_TYPE_INFO,
...
typedef enum {
  ...
  EBML_KR_VOLUME_INFO,
  EBML_KR_ANALOG_INFO,
  EBML_KR_TRANSPONDER_PATH_TYPE,
  EBML_KR_TRANSPONDER_PATH_TYPE_INFO,
...
typedef enum {
  ...
  DEBML_KR_TRANSPONDER_PATH_TYPE,
  DEBML_KR_TRANSPONDER_PATH_TYPE_INFO,
...
typedef enum {
  ...
  HELPERS_KR_TRANSPONDER_PATH_TYPE,
  HELPERS_KR_TRANSPONDER_PATH_TYPE_INFO,
