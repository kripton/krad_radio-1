...
int info_pack_to_text(char *text, uber_St *uber, int32_t max) {
  const info_pack_to_text_func to_text_functions[69] = {kr_alsa_info_to_text,
  ...
  kr_compositor_path_info_to_text,kr_compositor_info_to_text,
  kr_compositor_path_patch_to_text,kr_pos_to_text,
  ...
  kr_transponder_path_info_to_text,kr_transponder_path_patch_to_text,
