...
int info_pack_to_text(char *text, uber_St *uber, int32_t max) {
  const info_pack_to_text_func to_text_functions[66] = {kr_alsa_info_to_text,
  ...
  kr_compositor_path_info_to_text,kr_compositor_path_patch_to_text,
  kr_pos_to_text,kr_perspective_view_to_text,
  kr_perspective_to_text,krad_codec_t_to_text,
  ...
  kr_mixer_path_info_to_text,kr_mixer_path_patch_to_text,
  ...
  kr_transponder_path_patch_to_text,kr_v4l2_state_to_text,
