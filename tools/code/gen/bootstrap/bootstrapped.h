typedef enum {
  ...
  CGEN_KR_CLIENT,
  CGEN_KR_NIL,
  CGEN_KR_RADIO_PAYLOAD_TYPE,
  CGEN_KR_RADIO_PAYLOAD,
  CGEN_KRAD_RC_TYPE_T,
  CGEN_KRAD_RC_ST,
  ...
  CGEN_KR_TRANSPONDER_INFO_MEMBER,
  CGEN_KR_TRANSPONDER_INFO_PATCH_VALUE,
  CGEN_KR_TRANSPONDER_INFO_PATCH,
  ...
  CGEN_KR_TRANSPONDER_PATH_PATCH,
